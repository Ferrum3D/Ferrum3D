...
namespace FE::Graphics::Vulkan
{
    ...
    Core::GeometryHandle GeometryPool::Allocate(const Core::GeometryAllocationDesc& desc)
    {
        ...
        Bit::Traverse(activeStreamMask, [&](const uint32_t streamIndex) {
            ...
            bufferDesc.m_usage = Core::ResourceMemory::kDeviceLocal;
        ...
        if (isMeshlet)
        {
            ...
            primitivesBufferDesc.m_usage = Core::ResourceMemory::kDeviceLocal;
            ...
            meshletsBufferDesc.m_usage = Core::ResourceMemory::kDeviceLocal;
