...
namespace FE::Graphics::Vulkan
{
    namespace
    {
        ...
        VkImageAspectFlags TranslateImageAspect(const Core::ImageAspect aspect)
        {
            switch (aspect)
            {
            default:
        ...
        VkImageSubresourceRange TranslateSubresourceRange(const Core::TextureSubresource subresource)
        {
            ...
            vkSubresource.aspectMask = TranslateImageAspect(subresource.m_aspect);
    ...
    void FrameGraph::ExecutePassBarriersInternal(PassNode& pass)
    {
        ...
        const CommandBuffer* commandBuffer = m_commandQueue->GetCurrentGraphicsCommandBuffer();
