...
{
    inline VkAccessFlags GetAccessMask(RHI::ResourceState state)
    {
        using RHI::ResourceState;

        static auto Conversions = []() {
            std::array<VkAccessFlags, festd::to_underlying(RHI::ResourceState::kCount)> result{};
            // clang-format off
    ...
    inline VkImageLayout VKConvert(RHI::ResourceState state)
    {
        using RHI::ResourceState;

        static auto Conversions = []() {
            std::array<VkImageLayout, festd::to_underlying(RHI::ResourceState::kCount)> result{};
