...
namespace FE::Osmium
{
    extern "C"
    {
        FE_DLL_EXPORT ImageAssetStorage* ImageAssetStorage_Load(Assets::IAssetManager* manager, const UUID* assetID)
        {
            return fe_assert_cast<ImageAssetStorage*>(manager->LoadAsset(*assetID));
        }
