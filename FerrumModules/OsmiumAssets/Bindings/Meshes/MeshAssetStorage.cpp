...
namespace FE::Osmium
{
    extern "C"
    {
        FE_DLL_EXPORT MeshAssetStorage* MeshAssetStorage_Load(Assets::IAssetManager* manager, const char* assetID)
        {
            return fe_assert_cast<MeshAssetStorage*>(manager->LoadAsset(Assets::AssetID(assetID)));
        }
