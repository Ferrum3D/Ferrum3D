...
namespace FE
{
    ...
    public:
        ...
        inline constexpr FeVector3<T> operator+(const FeVector3<T>& other) const
        {
        ...
        inline constexpr FeVector3<T> operator*(const T factor) const
        {
            FeVector3<T> result{ *this };
            result *= factor;
            return result;
        ...
        inline constexpr FeVector3<T> operator/(const T divisor) const
        {
            FeVector3<T> result{ *this };
            result /= divisor;
            return result;
        ...
        inline constexpr bool operator==(const FeVector3<float>& other) const
        {
