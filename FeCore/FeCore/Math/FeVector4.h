...
namespace FE
{
    ...
    public:
        ...
        inline constexpr FeVector4<T> operator+(const FeVector4<T>& other) const
        {
        ...
        inline constexpr FeVector4<T> operator*(const T factor) const
        {
            FeVector4<T> result{ *this };
            result *= factor;
            return result;
        ...
        inline constexpr FeVector4<T> operator/(const T divisor) const
        {
            FeVector4<T> result{ *this };
            result /= divisor;
            return result;
        ...
        inline constexpr bool operator==(const FeVector4<float>& other) const
        {
