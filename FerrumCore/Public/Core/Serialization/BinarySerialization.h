...
{
    struct PackedBinaryFormat final : public SerializationFormat
    {
        PackedBinaryFormat();
        ~PackedBinaryFormat() override;
    ...
    struct TaggedBinaryFormat final : public SerializationFormat
    {
        TaggedBinaryFormat();
        ~TaggedBinaryFormat() override;
