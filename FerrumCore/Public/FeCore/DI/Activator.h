...
namespace FE::DI
{
    ...
    class alignas(64) ServiceActivator final
    {
        ...
        struct ResolveContext final
        {
            ...
            {
                return NewImpl(pAllocator, a1, a2, args...);
            }
    ...
    template<class T>
    inline T* New(std::pmr::memory_resource* pAllocator)
    {
